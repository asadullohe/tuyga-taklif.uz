...
export default async function LoginPage({ searchParams }: PageProps) {
  ...
  return (
    <>
      <AppHeader />
      <main className="min-h-[calc(100vh-65px)] overflow-hidden bg-[radial-gradient(circle_at_20%_20%,rgba(244,114,182,0.18),transparent_28%),radial-gradient(circle_at_80%_10%,rgba(20,184,166,0.18),transparent_24%),linear-gradient(135deg,#fffaf4_0%,#f6fbf8_52%,#fff1f5_100%)] px-4 py-8">
